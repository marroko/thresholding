...
%             squareSide = [70 70];
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.BinaryzacjaMarekKietykaMichaLeszczyskiUIFigure.Name = 'Binaryzacja - Marek Kiełtyka, Michał Leszczyński';
            ...
            app.BinaryzacjametodOtsuButton.Text = {'Binaryzacja'; 'metodą Otsu'};
            ...
            app.BinaryzacjazprogiemwasnymButton.Text = {'Binaryzacja'; 'z progiem własnym'};
            ...
            app.PrgwasnyEditFieldLabel.Text = 'Próg własny';
            ...
            app.MiejscenawczytanyobrazLabel.VerticalAlignment = 'center';
            ...
            app.MiejscenazbinaryzowanyobrazLabel.VerticalAlignment = 'center';
